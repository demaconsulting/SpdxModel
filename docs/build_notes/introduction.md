...
This document contains the build notes for SpdxModel.

## Purpose

This document provides a record of the changes, new features, and bug fixes included
in this release of SpdxModel. It also records the versions of all tools used in
...
- [SpdxModel releases](https://github.com/demaconsulting/SpdxModel/releases)
