...
[TestClass]
public class SpdxJsonDeserializeFile
{
    [TestMethod]
    public void DeserializeFile()
    {
        ...
        Assert.AreEqual("MIT", file.LicenseConcluded);
    ...
    public void DeserializeFiles()
    {
        ...
        // Act
        var files = SpdxJsonDeserializer.DeserializeFiles(json);
        ...
        Assert.AreEqual("MIT", files[0].LicenseConcluded);
