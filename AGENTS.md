...
- **project-name**: `SpdxModel`
- **organization**: DEMA Consulting
- **project-tagline**: SPDX document model for .NET
- **description**: SpdxModel is a modern C# library for working with SPDX (Software Package Data
  Exchange) documents. It provides a comprehensive in-memory model for reading, manipulating, and
  writing SPDX Software Bill of Materials (SBOM) files in JSON format, with full support for SPDX
  2.2 and 2.3 specifications.
- **languages**: `C#`
- **technologies**: `.NET`, `.NET Standard 2.0`, `NuGet`
...
└── test/
    └── DemaConsulting.SpdxModel.Tests/
```
